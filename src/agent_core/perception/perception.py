...
# Type hint for processor functions
ProcessorFunc = Callable[[Any], Awaitable[Dict[str, Any]]]


class BasePerceptionModule:
    """
    Base perception module for AI Studio Agents.
    ...
    def __init__(self):
        ...
        self.input_processors: Dict[str, ProcessorFunc] = {}
    ...
    def register_processor(self, input_type: str, processor_func: ProcessorFunc) -> None:
        """
